 ...
 */
const get = (id: string): IBoard => getBoard(id);
 ...
 */
const update = (id: string, data: IUpdateBoardData): IBoard => updateBoard(id, data);
 ...
 */
const deleteBoard = (id: string): void => deleteBoardById(id);
