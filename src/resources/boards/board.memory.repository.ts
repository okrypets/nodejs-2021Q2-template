 ...
 */
const getAll = async (): Promise<IBoard[]> => getBoards();
 ...
 */
const get = async (id: string): Promise<IBoard | boolean> => getBoard(id);
 ...
 */
const create = async (data: IBoard): Promise<IBoard> => createBoard(data);
 ...
 */
const update = async (id: string, data: IUpdateBoardData): Promise<IBoard | boolean> => updateBoard(id, data);
